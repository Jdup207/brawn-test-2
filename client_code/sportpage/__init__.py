...
from ..logactivities import logactivities
  ...
  # all the code for page existing.
class sportpage(sportpageTemplate):
  def __init__(self, **properties):
    # Set Form properties and Data Bindings.
    self.init_components(**properties)

  # how to navigate the app, navigation bar
  # How to get back to Home page. Home button
  def home_button_click(self, **event_args):
    """This method is called when the button is clicked"""
    open_form('index')

  # How to get to Habits. Habits button
  def habits_button_click(self, **event_args):
    """This method is called when the button is clicked"""
    open_form('habitspage')

  # How to get to Management. management button
  ...
  # how to get into activity summary page.
